...
% This template is not designed for font sizes other than 12pt.
...
\title{A Forensically Sound Method For Evidence\\
       Extraction From Heavy Truck ECMs}  % The title with line breaks for the front pages.
...
\secondmember{Jeremy Daily} % name of second member or co-advisor
\thirdmember{John Hale}   % name of third member
\fourthmember{Peter Hawrylak} % as needed
\fifthmember{Akhilesh Bajaj}   % as needed


\numofpages{105}                    % number of pages in the document
\numofchapters=7                   % number of chapters in the document
\lastchapter{Conclusions and Future Work}	  % the title of the last numbered chapter
